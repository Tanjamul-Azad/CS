...
**For the full story in the order it was actually reasoned through, read the ten documents in "The spine" below. Everything else is reference.**
...
## The spine — read these ten, in this order
